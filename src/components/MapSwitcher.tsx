    ...
    <>
      ...
      <div ref={wrapRef} className="relative shrink-0 sm:hidden">
        <button
          ...
          aria-expanded={open}
          className={[
            'flex max-w-[44vw] items-center gap-1 rounded-lg border bg-panel px-2 py-1 text-sm font-medium transition-colors',
        ...
        <AnimatePresence>
          {open && (
            <motion.div
              ...
              className="absolute left-0 top-full z-40 mt-2 w-max min-w-[9rem] max-w-[72vw] rounded-2xl border border-border bg-panel/95 p-1.5 shadow-[var(--shadow-pop)] backdrop-blur-xl"
            >
              {maps.map((m) => {
                ...
                return (
                  <button
                    ...
                    className={[
                      'flex w-full items-center truncate rounded-lg px-2.5 py-2 text-left text-base transition-colors',
