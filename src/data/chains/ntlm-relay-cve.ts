...
export const ntlmRelayCveNodes: TechniqueNodeDef[] = [
  ...
  },
  {
    ...
    opsec: 'Memory-corruption PoC: can BSOD/crash the target if the kernel grooming fails — risky on production hosts. SMBv1 exploit traffic and the resulting SYSTEM-level process are detectable; disabling SMBv1 and patching fully mitigate.',
    difficulty: 'medium',
  },
  {
    id: 'proxyshell',
